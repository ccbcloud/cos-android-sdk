...
uploadData.cosPath = "[对象键](https://github.com/ccbcloud/cos-api#基本信息)，即存储到 COS 上的绝对路径"; //格式如 cosPath = "test.txt";
...
String cosPath = "[对象键](https://github.com/ccbcloud/cos-api#基本信息)，即存储到 COS 上的绝对路径"; //格式如 cosPath = "test.txt";
 ...
 * corsRule.allowedOrigin: 允许的访问来源，支持通配符 * , 格式为：协议://域名[:端口]如：http://www.ccb.com
...
corsRule.id = "123";
corsRule.allowedOrigin = "https://yun.ccb.com";
